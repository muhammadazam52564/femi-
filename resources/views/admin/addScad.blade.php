...
@section('content')
<form method="POST" action="{{ route('admin.add-scad') }}" enctype="multipart/form-data">
    @csrf
                    ...
                    <div class="col-md-9">
                        <div class="row border p-4">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="title" id="title" class="form-control" placeholder="daily health scadual" />
                            </div>
                            <!-- <div class="col-md-6 ">
                    ...
                    <div class="col-md-9">
                        <div class="row border p-4">
                            <div class="col-md-6 mt-4">
                                <label for="fact" class="btn btn-primary btn-lg">Health Scadual Icon </label>
